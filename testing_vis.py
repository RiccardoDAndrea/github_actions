...
plt.subplots_adjust(wspace=0.4, hspace=0.4)  # Horizontale und vertikale Abstände anpassen
...
# Datumsbeschriftungen um 45 Grad drehen
...
ax4.set_title('Stock Prices Over Time')
